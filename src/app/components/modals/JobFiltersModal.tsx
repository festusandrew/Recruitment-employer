            ...
            <div className="bg-white rounded-2xl  w-full max-w-3xl max-h-[90vh] overflow-hidden">
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-slate-900">Filter Jobs</h2>
                ...
                <div className="p-6 overflow-y-auto" style={{ maxHeight: "calc(90vh - 180px)" }}>
                    <div className="space-y-6">
                        {/* Department */}
                        <div>
                            <label className="block text-sm text-slate-700 mb-3">Department</label>
                                ...
                                {departments.map((dept) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg text-sm border transition-all ${filters.departments.includes(dept)
                                                ...
                                                : "bg-white text-slate-700 border-gray-300 hover:border-blue-300"
                                            }`}
                                    >
                        ...
                        {/* Location */}
                        <div>
                            <label className="block text-sm text-slate-700 mb-3">Location</label>
                        ...
                        {/* Job Type */}
                        <div>
                            <label className="block text-sm text-slate-700 mb-3">Job Type</label>
                        ...
                        {/* Status */}
                        <div>
                            <label className="block text-sm text-slate-700 mb-3">Status</label>
                            <div className="grid grid-cols-4 gap-2">
                                {statuses.map((status) => (
                                    <button
                                        key={status}
                        ...
                        {/* Date Range */}
                        <div>
                            <label className="block text-sm text-slate-700 mb-3">Posted Date</label>
                            <select
                        ...
                        {/* Applicant Range */}
                        <div>
                            <label className="block text-sm text-slate-700 mb-3">Number of Applicants</label>
                            <select
