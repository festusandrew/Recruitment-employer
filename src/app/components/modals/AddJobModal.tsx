                            ...
                            <div className="p-6 border-b border-white/10 relative z-10">
                                <div className="flex items-center gap-3.5">
                                    ...
                                    <div className="min-w-0">
                                        <h2 className="text-sm font-extrabold text-white tracking-wide">POST NEW JOB</h2>
                                        <p className="text-[10px] text-rose-200/70 font-semibold truncate uppercase tracking-wider mt-0.5">
                                            {formData.title || "New Position"}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex-1 flex flex-col min-w-0 bg-white">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div className="relative w-48">
                                                                <select
                                                                    ...
                                                                    className="w-full px-3 py-2 bg-gray-50 border border-gray-250 rounded-lg text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#800020]/15 appearance-none cursor-pointer"
                                                                >
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3.5 mt-5 pt-4 border-t border-gray-200">
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() => setIsEditingTemplate(false)}
                                                        className="px-4 py-2 bg-white hover:bg-gray-100 border border-gray-250 text-gray-600 rounded-lg text-xs font-bold transition-colors cursor-pointer"
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
                            ...
                            <div className="flex items-center justify-end gap-3.5 p-6 border-t border-gray-100 bg-gray-50 flex-shrink-0">
                                <button
                                    type="button"
                                    onClick={onClose}
                                    className="px-5 py-2.5 rounded-xl border border-gray-250 text-gray-700 bg-white hover:bg-gray-50 transition-all font-bold text-xs  cursor-pointer tracking-wider"
                                >
                                    CANCEL
                                </button>
                                <motion.button
