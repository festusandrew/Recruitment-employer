            ...
            <div className="bg-white rounded-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl text-slate-900">{company.name}</h2>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="bg-gray-50 border border-slate-200 rounded-lg p-4 space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm text-slate-900">{company.joined}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-slate-600">Contact Email</span>
                                <span className="text-sm text-slate-900">{company.email}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm text-slate-900">Posted new job: Senior React Developer</p>
                            ...
                            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm text-slate-900">Added 3 new team members</p>
                            ...
                            <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm text-slate-900">Upgraded to {company.plan} plan</p>
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-slate-200">
                        ...
                        <button className="flex-1 px-4 py-2.5 border border-gray-300 text-slate-700 rounded-lg hover:bg-gray-50 transition-colors" onClick={() => setIsEmailModalOpen(true)}>
                            Send Email
                        </button>
