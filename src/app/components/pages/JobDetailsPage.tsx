        ...
        <div className="flex flex-col h-full bg-gray-50/40 text-left">
            ...
            <div className="bg-white border-b border-gray-150">
                <div className="max-w-[1600px] mx-auto px-8 py-6">
                    <button
                        onClick={onBack}
                        className="flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-gray-900 transition-colors mb-4 cursor-pointer select-none"
                    >
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
                        <div>
                            <div className="flex items-center gap-3 mb-2 flex-wrap">
                                <h1 className="text-2xl font-extrabold text-gray-950 tracking-tight leading-none">{job.title}</h1>
                                <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold border uppercase tracking-wider ${getStatusTheme(job.status)}`}>
                                    {job.status}
                                </span>
                                <span className="text-xs text-gray-400 font-semibold">Posted {job.posted || "3 days ago"}</span>
                            </div>
                            <div className="flex items-center flex-wrap gap-x-6 gap-y-2 text-xs text-gray-500 font-semibold mt-3">
                        ...
                        <div className="flex items-center flex-wrap gap-3.5">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.99 }}
                                onClick={onEdit}
                                className="px-4 py-2.5 border border-gray-200 text-gray-700 bg-white hover:bg-gray-50 rounded-xl transition-all font-bold text-xs shadow-3xs cursor-pointer flex items-center gap-2"
                            >
                            ...
                            <motion.button
                                ...
                                className="px-5 py-2.5 bg-[#800020] hover:bg-[#600018] text-white rounded-xl transition-all font-extrabold text-xs shadow-md border border-[#800020]/10 hover:shadow-glow-maroon flex items-center justify-center gap-2 cursor-pointer tracking-wider"
                            >
                ...
                <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <div className="bg-white rounded-2xl p-5 border border-gray-150 shadow-3xs relative overflow-hidden">
                                <div className="absolute top-0 left-0 w-full h-1 bg-[#800020]" />
                                <div className="flex items-center gap-2.5 mb-2 text-gray-600">
                                    <Users className="w-4.5 h-4.5 text-[#800020]" />
                                    <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Total Applicants</p>
                                </div>
                                <p className="text-3xl font-extrabold text-gray-900 leading-none mt-1">{job.applicants}</p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-5 border border-gray-150 shadow-3xs relative overflow-hidden">
                                ...
                                <p className="text-3xl font-extrabold text-gray-900 leading-none mt-1">24</p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-5 border border-gray-150 shadow-3xs relative overflow-hidden">
                                ...
                                <div className="flex items-center gap-2.5 mb-2 text-gray-600">
                                    ...
                                    <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Interviewed</p>
                                </div>
                                <p className="text-3xl font-extrabold text-gray-900 leading-none mt-1">8</p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-5 border border-gray-150 shadow-3xs relative overflow-hidden">
                                ...
                                <div className="flex items-center gap-2.5 mb-2 text-gray-600">
                                    ...
                                    <p className="text-xs font-bold uppercase tracking-wider text-gray-400">Placed Hires</p>
                                </div>
                                <p className="text-3xl font-extrabold text-gray-900 leading-none mt-1">2</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-150 shadow-premium p-8 relative overflow-hidden">
                            ...
                            <h3 className="text-sm font-extrabold text-gray-950 uppercase tracking-wider mb-4 flex items-center gap-2">
                                <Briefcase className="w-4.5 h-4.5 text-[#800020]" />
                            ...
                            <div className="text-sm text-gray-600 leading-relaxed space-y-4 font-medium">
                                ...
                                <h4 className="text-gray-950 font-extrabold text-xs uppercase tracking-wider mt-6 mb-3">Key Requirements & Experience</h4>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-150 shadow-premium p-6">
                            <h3 className="text-xs font-bold text-gray-950 uppercase tracking-wider mb-5 pb-3 border-b border-gray-100">Job Specification</h3>
                            <div className="space-y-4">
                                <div className="flex items-center gap-3.5">
                                    <div className="w-10 h-10 bg-rose-50 border border-rose-100 rounded-xl flex items-center justify-center text-[#800020] flex-shrink-0">
                                        <DollarSign className="w-4.5 h-4.5" />
                                    </div>
                                    <div>
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Salary Bandwidth</p>
                                ...
                                <div className="flex items-center gap-3.5">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Experience Level</p>
                                ...
                                <div className="flex items-center gap-3.5">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Engagement Type</p>
                        ...
                        {/* Pipeline Progress */}
                        <div className="bg-white rounded-2xl border border-gray-150 shadow-premium p-6">
                            <h3 className="text-xs font-bold text-gray-950 uppercase tracking-wider mb-5 pb-3 border-b border-gray-100">Pipeline Velocity</h3>
                            <div className="space-y-4 text-xs font-semibold text-gray-650">
                                <div>
                                    ...
                                    <Progress value={100} className="h-1.5 bg-gray-100" style={{'--progress-background': '#800020'} as any} />
                                </div>
                                <div>
                                    <div className="flex items-center justify-between mb-1.5">
                                    ...
                                    <Progress value={35} className="h-1.5 bg-gray-100" style={{'--progress-background': '#800020'} as any} />
                                </div>
                                <div>
                                    <div className="flex items-center justify-between mb-1.5">
                                    ...
                                    <Progress value={9} className="h-1.5 bg-gray-100" style={{'--progress-background': '#800020'} as any} />
                                </div>
                                <div>
                                    <div className="flex items-center justify-between mb-1.5">
                                    ...
                                    <Progress value={2} className="h-1.5 bg-gray-100" style={{'--progress-background': '#800020'} as any} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-150 shadow-premium p-6">
                            <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
                                <h3 className="text-xs font-bold text-gray-950 uppercase tracking-wider">Recent Applicants</h3>
                                <button
                                    onClick={onViewApplicants}
                                    className="text-xs font-bold text-[#800020] hover:text-[#600018] transition-colors flex items-center gap-1 select-none"
                                >
                                    <span>View all</span>
                            ...
                            <div className="space-y-3">
                                {recentApplicants.map((applicant) => (
                                    <div 
                                        key={applicant.id} 
                                        onClick={onViewApplicants}
                                        className="flex items-center gap-3 p-3 bg-gray-50/65 rounded-xl hover:bg-gray-100/50 transition-all cursor-pointer border border-transparent hover:border-gray-200"
                                    >
                                        <Avatar className="w-10 h-10 border border-white shadow-3xs flex-shrink-0">
                                            <AvatarImage src={applicant.avatar} />
                                            <AvatarFallback className="bg-primary   text-white font-bold text-xs">{applicant.name.charAt(0)}</AvatarFallback>
                                        </Avatar>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-bold text-gray-900 truncate">{applicant.name}</p>
                                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-0.5">Applied {applicant.time}</p>
                                        </div>
